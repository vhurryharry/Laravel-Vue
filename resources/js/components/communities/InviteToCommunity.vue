          ...
          <div class="mx-auto flex flex-col px-6 py-4 w-5/6 justify-center items-center">
            <div class="flex-col items-center justify-center mb-2">
              <p class="text-center">
                ...
                <span class="rubik-bold">{{ this.guestSize }} people</span> to your community
                <span class="text-teal rubik-bold">{{ community.name }}</span>
              </p>
            </div>
...
export default {
    ...
    computed: {
        ...mapState({
            ...
            profiles: state => state.communities.profilesThatCanBeInvited
        })
    },
    created() {
